...
test_mvi	defTest($06,$A5,$00,$00, $C407,  msbt,$DE89,$7455,$53,$A5,$5509)	; MVI
	...
	defMask(                 $FFFF, $0000,$FFFF,$FFFF,$D5,$FF,$FFFF)
	defCRC($4C,$87,$D6,$E5)
	Text_STR("mvi <b,c,d,e,h,l,m,a>,nn . ")
